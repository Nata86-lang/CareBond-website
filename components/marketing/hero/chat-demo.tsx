...
const PHASES: Phase[] = [
  {
    ...
    id: "p1",
    side: "patient",
    text: "¿Cómo se siente hoy, doctora?",
    visibleFrom: 1,
  },
  {
    kind: "translation",
  ...
  },
  {
    ...
    id: "d1",
    side: "doctor",
    text: "Très bien, merci. Comment va votre sommeil ?",
    visibleFrom: 3,
  },
  {
    kind: "translation",
    ...
    from: "FR",
    to: "ES",
    text: "Muy bien, gracias. ¿Cómo va su sueño?",
    visibleFrom: 4,
  },
  {
    kind: "bubble",
    id: "p2",
    side: "patient",
    text: "Mejor, gracias a la nueva medicación.",
    visibleFrom: 5,
  },
  {
    kind: "translation",
    ...
    from: "ES",
    to: "FR",
    text: "Mieux, grâce au nouveau médicament.",
    visibleFrom: 6,
  },
];
